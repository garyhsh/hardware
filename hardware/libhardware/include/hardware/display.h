...
struct display_device_t
{
    ...
    int (*isenablemp)           (struct display_device_t *dev);
    /**
    ...
    int (*enabledisplaybacklight)(struct display_device_t *dev, int displayno,int enable);
	int (*setdisplaybacklightmode)(struct display_device_t *dev, int mode);
	int (*setdisplaybacklightdemomode)(struct display_device_t *dev, int mode);
	int (*setdisplayenhancemode)(struct display_device_t *dev, int mode,int chanel);
	int (*getdisplayenhanceenable)(struct display_device_t *dev, int chanel);
	int (*setdisplayenhancedemomode)(struct display_device_t *dev, int mode,int chanel);
